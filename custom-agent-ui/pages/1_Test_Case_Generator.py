    ...
    if gen_clicked:
        ...
        with st.spinner(f"Step 2/3: Generating test cases with {OPENAI_MODEL}…"):
            try:
                ...
                #         "title": "[FR-01] Add Caller via SF Click-to-Dial verifies button functionality",
                #         "priority": "High",
                #         "type": "Functional",
                #         "preconditions": "Admin role, agent has one active call and no consult calls",
                #         "steps": "1. Open SF Click-to-Dial modal\n2. Click Add Caller button",
                #         "expected_result": "Add Caller button is enabled and initiates a consult call",
                #         "test_data": "CY_Test | Active call with 3 participants",
                #         "automation_status": "Automated",
                #         "roles_covered": ["admin"],
                #     },
                #     {
                #         "tc_id": f"{feature_prefix}-002",
                #         "title": "[FR-02]  Add Caller button enabled with one active call and no consult calls",
                #         "priority": "Medium",
                #         "type": "Functional",
                #         "preconditions": "Admin role, agent has one active call and no consult calls",
                #         "steps": "1. Ensure one active call\n2. Verify Add Caller button state",
                #         "expected_result": "Add Caller button is enabled",
                #         "test_data": "CY_Test | Active call with 3 participants",
                #         "automation_status": "Automated",
                #         "roles_covered": ["admin"],
                #     },
